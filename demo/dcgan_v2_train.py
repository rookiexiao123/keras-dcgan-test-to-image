...
def main():
    ...
    img_dir_path = current_dir + '/data/pokemon/img'#img_dir_path = 'D:/ImageRecognition/large logo dataset/LLD-logo_files/LLD-logo-files'#
    txt_dir_path = current_dir + '/data/pokemon/txt'#txt_dir_path = 'D:/ImageRecognition/keras-text-to-image-master/keras-text-to-image-master/demo/data/txt'#
